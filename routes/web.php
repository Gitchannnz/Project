...
Route::middleware(['auth', AuthAdmin::class])->group(function() {
    ...
    Route::get('/admin/receipt/{id}', [AdminController::class, 'print_order'])->name('admin.print.order');
   Route::get('/admin/transactions-history', [AdminController::class, 'transactions_history'])->name('admin.transactions.history');
   Route::post('/admin/transactions/export', [AdminController::class, 'exportTransactions'])->name('admin.transactions.export');
