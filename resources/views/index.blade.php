@extends('layouts.app')
@section('content')
{{-- main tag from index then added asset method on products --}}
<main>
...
<section class="swiper-container js-swiper-slider swiper-number-pagination slideshow" data-settings='{
  ...
  <div class="swiper-wrapper">
    <div class="swiper-slide">
      <div class="overflow-hidden position-relative h-100">
        <div class="slideshow-character position-absolute bottom-0 pos_right-center">
          <img loading="lazy" src="{{ asset('assets/images/home/demo3/nbsc tee-gray.png') }}" width="542" height="733"
            alt=""
        ...
        <div class="slideshow-text container position-absolute start-50 top-50 translate-middle">
          ...
          NBSC</h6>
          <h2 class="h1 fw-normal mb-0 animate animate_fade animate_btt animate_delay-5">Welcome to IGP</h2>
          <h2 class="h1 fw-bold animate animate_fade animate_btt animate_delay-5">NBSC School Supplies</h2>
          <a href="#"
    ...
    <div class="swiper-slide">
      <div class="overflow-hidden position-relative h-100">
        <div class="slideshow-character position-absolute bottom-0 pos_right-center">
          <img loading="lazy" src="{{ asset('assets/images/nbsc tee-black.png') }}" width="400" height="733"
            alt="Woman Fashion 1"
            class="slideshow-character__img animate animate_fade animate_btt animate_delay-9 w-auto h-auto" />
        ...
        <div class="slideshow-text container position-absolute start-50 top-50 translate-middle">
          ...
          <h2 class="h1 fw-bold animate animate_fade animate_btt animate_delay-5">NBSC Apparels</h2>
          <a href="#"
            class="btn-link btn-link_lg default-underline fw-medium animate animate_fade animate_btt animate_delay-7">Shop
            Now</a>
        </div>
    ...
    <div class="swiper-slide">
      <div class="overflow-hidden position-relative h-100">
        <div class="slideshow-character position-absolute bottom-0 pos_right-center">
          <img loading="lazy" src="{{ asset('assets/images/nbsc tee-gray.png') }}" width="400" height="690"
            alt="Woman Fashion 2"
        ...
        <div class="slideshow-text container position-absolute start-50 top-50 translate-middle">
          <h6 class="text_dash text-uppercase fs-base fw-medium animate animate_fade animate_btt animate_delay-3">
            NBSC</h6>
          <h2 class="h1 fw-normal mb-0 animate animate_fade animate_btt animate_delay-5">Welcome to IGP</h2>
          <h2 class="h1 fw-bold animate animate_fade animate_btt animate_delay-5">NBSC Merch</h2>
          <a href="#"
            class="btn-link btn-link_lg default-underline fw-medium animate animate_fade animate_btt animate_delay-7">Shop
            Now</a>
        </div>
